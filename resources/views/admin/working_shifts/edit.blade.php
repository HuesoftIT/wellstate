...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li>
            <a href="{{ url('/admin/working-shifts') }}">
                {{ __('working_shifts.working_shifts') }}
            </a>
        </li>
    ...
    <div class="box box-success">
        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <a href="{{ !empty($backUrl) ? $backUrl : url('/admin/working-shifts') }}" class="btn btn-warning btn-sm">
        ...
        {!! Form::model($workingShift, [
            'method' => 'PATCH',
            'url' => ['/admin/working-shifts', $workingShift->id],
            'class' => 'form-horizontal',
        ]) !!}

        @include('admin.working_shifts.form', [
