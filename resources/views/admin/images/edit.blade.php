...
@section('main-content')
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <a href="{{ !empty($backUrl) ? $backUrl : url('/admin/images') }}" class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i>
        ...
        @include ('admin.images.form', ['submitButtonText' => __('message.update')])
