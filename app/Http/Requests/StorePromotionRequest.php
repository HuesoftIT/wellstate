...
class StorePromotionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'discount_code' => 'nullable|string|max:100|unique:promotions,discount_code',
    ...
    public function messages()
    {
        return [
            ...
            'discount_code.required' => 'Mã khuyến mãi là bắt buộc',
            'discount_code.unique' => 'Mã khuyến mãi đã tồn tại',

            'image.required' => 'Ảnh khuyến mãi là bắt buộc',
